...
Global $serverHost = IniRead("C:\LaserMaxx\shared\lmxControl.ini", "Result", "Host", "http://lac.local")
Global $updatePath = IniRead("C:\LaserMaxx\shared\lmxControl.ini", "Result", "Update", "/api/results/import")
Global $mountPath = IniRead("C:\LaserMaxx\shared\lmxControl.ini", "Result", "Update", "/api/mount")
