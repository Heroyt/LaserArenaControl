...
export default class Game {
	...
	constructor() {
		...
		this.$groupMusicModesLabel = document.querySelector('label[for="music-mode-grouped"]');
		this.$playlist = document.getElementById('playlist-select') as HTMLSelectElement;
		this.$usePlaylist = document.getElementById('playlists') as HTMLInputElement;
