            ...
            editVariationsBtn.addEventListener('click', () => {
                ...
                getGameModeVariations(modeId)
                    .then(response => {
                        ...
                        addVariationWrapper.innerHTML = `<div class="form-floating">` + `<select id="existing-variations" class="form-select"></select>` + `<label for="existing-variations">${messages.existingVariations}</label>` + `</div>` + `<button type="button" class="btn btn-success" id="addExistingVariation">${messages.add}</button>`;
                        ...
                        function newVariation(variation: Variation, values: VariationsValue[] = []) {
                            ...
                            values.forEach(value => {
                                ...
                                valueElement.innerHTML = `<div class="input-group">` + `<div class="input-group-text cursor-grab"><i class="fa-solid fa-bars"></i></div>` + `<div class="form-floating">` + `<input type="text" class="form-control" name="variation[${variation.id}][values][${i}][value]" id="variation-value-${variation.id}-${i}" value="${value.value}"/>` + `<label for="variation-value-${variation.id}-${i}">${messages.variationValue}</label>` + `</div>` + `<div class="form-floating">` + `<input type="text" class="form-control" name="variation[${variation.id}][values][${i}][suffix]" id="variation-suffix-${variation.id}-${i}" value="${value.suffix}"/>` + `<label for="variation-suffix-${variation.id}-${i}">${messages.variationSuffix}</label>` + `</div>` + `<input type="hidden" name="variation[${variation.id}][values][${i}][order]" class="orderInput" value="${value.order}">` + `<button class="btn btn-danger deleteVariationValue" type="button"><i class="fa-solid fa-trash"></i></button>` + `</div>`;
                            ...
                            addBtn.addEventListener('click', () => {
                                ...
                                valueElement.innerHTML = `<div class="input-group">` + `<div class="input-group-text cursor-grab"><i class="fa-solid fa-bars"></i></div>` + `<div class="form-floating">` + `<input type="text" class="form-control" name="variation[${variation.id}][values][${i}][value]" id="variation-value-${variation.id}-${i}" value=""/>` + `<label for="variation-value-${variation.id}-${i}">${messages.variationValue}</label>` + `</div>` + `<div class="form-floating">` + `<input type="text" class="form-control" name="variation[${variation.id}][values][${i}][suffix]" id="variation-suffix-${variation.id}-${i}" value=""/>` + `<label for="variation-suffix-${variation.id}-${i}">${messages.variationSuffix}</label>` + `</div>` + `<input type="hidden" name="variation[${variation.id}][values][${i}][order]" class="orderInput" value="${i}">` + `<button class="btn btn-danger deleteVariationValue" type="button"><i class="fa-solid fa-trash"></i></button>` + `</div>`;
        ...
        if (editModeNamesBtn) {
            editModeNamesBtn.addEventListener('click', () => {
                ...
                function createNameGroup(name: string = '') {
                    ...
                    elem.innerHTML = `<input type="text" name="modeNames[]" class="form-control" value="${name}" />` + `<button type="button" class="btn btn-danger remove"><i class="fa-solid fa-trash"></i></button>`
