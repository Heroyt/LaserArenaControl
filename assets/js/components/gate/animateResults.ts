...
export function animateResults(wrapper: HTMLDivElement) {
    ...
    let minScore: number = limits.min;
    let maxScore: number = limits.max;
 ...
 * @param players List of all player elements
 */
export function getPlayerPositions(players: PlayerData[]): PlayerPositions {
