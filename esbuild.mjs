...
await fontawesomeSubset({
    ...
    solid: ['arrow-up', 'arrow-down', 'money-bill-1-wave', 'person', 'heart', 'music', 'angle-down', 'angle-left', 'angle-right', 'angle-up', 'ban', 'cancel', 'check', 'circle-info', 'circle-question', 'download', 'edit', 'eye', 'eye-slash', 'file-pdf', 'filter', 'gear', 'gun', 'info', 'list', 'location-dot', 'magnifying-glass-plus', 'medal', 'pen-to-square', 'play', 'plus', 'question', 'ranking-star', 'right-from-bracket', 'right-to-bracket', 'share', 'star', 'stop', 'tag', 'trophy', 'user', 'user-clock', 'user-plus', 'xmark', 'moon', 'sun', 'print', 'display', 'cog', 'bars', 'save', 'trash', 'search', 'shuffle', 'chair', 'soap', 'upload', 'cloud', 'close', 'rotate', 'box-archive', 'bullseye', 'arrows-rotate', 'cloud-arrow-up', 'user-group', 'layer-group', 'people-group', 'clipboard-list', 'grip-lines', 'circle-chevron-up', 'circle-play', 'circle-stop', 'circle-exclamation', 'table-cells-large', 'magnifying-glass','caret-left','caret-right'],
}, "assets/fonts", {
